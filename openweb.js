(() => {
  ...
  const translations = {
    ...
    "pt-br": {
      message: `Nós lamentamos, mas o navegador que você está usando parece apoiar o <a href="https://github.com/RupertBenWiser/Web-Environment-Integrity">Web Environment Integrity API</a>. Essa adição hostil ao usuário em navegadores apoiados pelo Google <a href="https://yewtu.be/watch?v=0i0Ho-x7s_U">trabalha para minar a internet livre e gratuita</a>, e consequentemente não é suportado. Por favor, mude para a nova versão do <a href="https://www.mozilla.org/en-US/firefox/new/">Firefox</a> ou algum outro navegador que ainda dê algum valor à noção de controle do usuário e liberdade para usar nosso serviço. Obrigado pela sua compreensão. Para mais informações, visite <a href="${home_url}">${home_url.replace(
        "https://",
        ""
      )}</a>`,                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             },
    tr: {
